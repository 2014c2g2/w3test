#@+leo-ver=5-thin
#@+node:2014python.20150405232048.1840: * @file wsgi.py
# coding=utf-8
...
#@+<<declarations>>
#@+node:2014python.20150405232048.1841: ** <<declarations>> (wsgi)
import cherrypy
...
#@-<<declarations>>
#@+others
#@+node:2014python.20150405232048.1842: ** class Hello
################# (3) 程式類別定義區
...
class Hello(object):
    ...
    #@+others
    #@+node:2014python.20150405232048.1843: *3* __init__
    def __init__(self):
        # 配合透過案例啟始建立所需的目錄
    ...
    #@+node:2014python.20150405232048.1844: *3* index_orig
    ...
    def index_orig(self, toprint="Hello World!"):
        return toprint
    #@+node:2014python.20150405232048.1845: *3* hello
    @cherrypy.expose
    def hello(self, toprint="Hello World!"):
        return toprint
    #@+node:2014python.20150405232048.1846: *3* index
    @cherrypy.expose
    def index(self, guess=None, N=20, M=5, P=15):
    ...
    壓力角:<input type=text name=P>(請輸入標準值20度)<br />
    <input type=submit value=send>
    </form>
    <hr>
    <!-- 以下在網頁內嵌 Brython 程式 -->
    ...
    <form method=POST action=index>
    齒數:<output name=N for=str(N)><br />
    模數:<output name =M for=str(M)><br />
    壓力角:<output  name=P for=str(P)><br />
    </form>
    ...
    gear(400,400,300,'''+str(N)+''','''+str(M)+''','''+str(P)+''',"blue")
    </script>
    ...
    '''
        return outstring
    #@+node:2014python.20150405232048.1847: *3* twoDgear
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    '''
        ...
        return outstring
    #@+node:2014python.20150405232048.1848: *3* threeDgear
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    <form method=POST action=gear_weblink>
    齒數:<input type=text name=N><br />
    模數:<input type=text name=M><br />
    壓力角:<input type=text name=P><br />
    <input type=submit value=send>
    ...
    '''
        ...
        return outstring
    #@+node:2014python.20150405232048.1849: *3* do2Dgear
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    '''
        ...
        return outstring
    #@+node:2014python.20150405232048.1955: *3* do2Dgear2
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def do2Dgear2(self, N=None, M=None, P=None):
        outstring = "齒數"+"="+str(N)+"<br / >"+"模數"+"="+str(M)+"<br / >"+"壓力角"+"="+str(P)
        return outstring
    #@+node:2014python.20150405232048.1850: *3* do3Dgear
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    '''
        ...
        return outstring
    #@+node:2014python.20150405232048.1851: *3* mygeartest
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    gear(400,400,300,41,'''+str(N)+''','''+str(M)+''','''+str(P)+''',"blue")
    ...
    '''
        ...
        return outstring
    #@+node:2014python.20150405232048.1852: *3* my3Dgeartest
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    '''
        ...
        return outstring
    #@+node:2014python.20150405232048.1853: *3* doCheck
    @cherrypy.expose
    ...
    #@+node:2014python.20150405232048.1854: *3* guessform
    def guessform(self):
        # 印出讓使用者輸入的超文件表單
    ...
    <input type=submit value=send>
        ...
        return outstring
    #@+node:2014python.20150405233937.2033: *3* gear_weblink
    @cherrypy.expose
    def gear_weblink(self, N=20, M=5, P=15):
        outstring = '''<script type="text/javascript" src="/static/weblink/examples/jscript/pfcUtils.js"></script>
    <script type="text/javascript" src="/static/weblink/examples/jscript/wl_header.js">// <![CDATA[
